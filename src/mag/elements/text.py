...
class TextElement(Element):
    ...
    def __init__(self, text: str, x: int, y: int, *, size: int = 40, fill: tuple[int, ...] = (0, 0, 0), font_path: str | Path | None = None, stroke_width: int = 0, stroke_fill: tuple[int, ...] | None = None, visible: bool = True, z_index: int = 0) -> None:
