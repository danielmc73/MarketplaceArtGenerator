...
from mag.layouts import build_benefits_image, build_kit_campeao_image, build_principal_image, build_pump_image, build_quality_image, build_questions_image, build_versatility_image
